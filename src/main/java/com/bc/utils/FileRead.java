...
//        queryFile("E:\\wampserver\\www\\image\\","E:\\wampserver\\www\\image\\abc_1649746132653.jpg");
//
//    }
//    public static ArrayList<String> queryFile(String filePath,String testPath) throws IOException {
public static boolean queryFile(String filePath,String testPath) throws IOException {
...
//        }
        for (int i = 0; i < es.size(); i++){
            if (es.get(i).equals(testPath)){
                continue;
            }
            File file1 = new File(es.get(i));
            File file2 = new File(testPath);
            double SimilarData = getSimilarity(file1,file2);
            if(SimilarData > 60){
                flag = false;
            }
        }
